...
export function BankCard({ number, name, cardholder, balance, bank_logo, expire_date, cvv, currency, id, card_style }: {  number?: any, name?: any, cardholder?: any, balance?: any, bank_logo?: any,  expire_date?: any, cvv?: any, currency?:any, id?: any, card_style?: any} ) {
                ...
                style={
                  {
                    ...
                    width: 300,
                    position: 'relative',
                    background: card_style || 'linear-gradient(to top right, hsl(226, 70.0%, 55.5%), #E18BFF)',
